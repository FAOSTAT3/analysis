define(['jquery',
    ...
    global.TILESMGR = function() {
        ...
        var createChartsAndPopulateTable = function(country_code, update_tables, add_user_data) {
        ...
        var createCharts = function(country, add_user_data) {
        ...
        /* Charts template. */
        var createChart = function(chart_id, title, series, add_user_data, colors) {
            var p = {
                chart: {
                    height: 400,
                    spacingBottom: 50,
        ...
        var plotSeries = function(series, datasource, domain_code, country, item, element) {
            var sql = {};
            switch (datasource) {
                case 'faostat':
        ...
        var prepare_chart_data = function (series, db_data, datasource) {
            var json = db_data;
            if (typeof json == 'string')
        ...
        var showHideTable = function(left_table_id, right_table_id, label_id) {
        ...
        var addDataToSingleChart = function(input_prefixes, series_indices, chart_id) {
        ...
        var populateTable_EmissionsDatabaseNC = function(country_code, callback) {
            var sql = {
        ...
        var populate_tables = function(country_code, callback) {
        ...
        var populateTable_EmissionsDatabaseFAOSTAT = function(country_code) {
            var sql = {
                'query' : "SELECT A.AreaNameS, E.ElementListNameS, I.ItemNameS, I.ItemCode, D.Year, D.value " +
                    "FROM Data AS D, Area AS A, Element AS E, Item I " +
                    "WHERE D.DomainCode = 'GT' AND D.AreaCode = '" + country_code + "' " +
        ...
        var handlefilescatter = function(e) {
